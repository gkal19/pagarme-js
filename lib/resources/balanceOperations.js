...
const findOne = curry((opts, {id}) => request.get(opts, routes.balanceOperations.details(id), {})
)
...
const findRecipientsWithBalanceId = curry((opts, {id, recipientId}) => request.get(opts, routes.balanceOperations.recipients.find(id, recipientId), {})
)
